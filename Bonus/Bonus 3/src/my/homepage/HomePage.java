...
import Backend.User;
import my.cadastro.AlterarCadastro;
...
public class HomePage extends javax.swing.JFrame {
     ...
     */
    public HomePage(Sistema sm, String email, String senha) {
        initComponents();
        this.sis = sm;
        this.usuario = sm.BuscaUsuario(email, senha);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        AlterarCadastro TelaAlterarCadastro = new AlterarCadastro(sis, usuario);
